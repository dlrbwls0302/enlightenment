...
const Magazine = ({ index, id, like, title, value, description, createdAt, handleTogleMagazine }) => {
    ...
    return (
        <div className="magazine" onClick={() => handleTogleMagazine(id, title, description, like, createdAt)} style={value === undefined ? { backgroundImage: `url(${dummyImg})` } :
