...
const Magazine = ({ index, like, title, value, description, createdAt, handleTogleMagazine }) => {
    ...
    return (
        <div className="magazine" onClick={() => handleTogleMagazine(title, description, like, createdAt)} style={value === undefined ? { backgroundImage: `url(${dummyImg})` } :
